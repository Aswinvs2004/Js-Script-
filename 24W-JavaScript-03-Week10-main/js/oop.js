...
*/
function Hamburger(bun, meat, cheese, toppings) {
    this.bun = bun;
    this.meat = meat;
    this.cheese = cheese;
    ...
    this.describe = function() {
        let description = `This hamburger has a ${this.bun} bun, ${this.meat} patty, ${this.cheese} cheese`;
        if (this.toppings.length > 0) {
            description += `, and toppings: ${this.toppings.join(", ")}.`;
        } else {
            description += " and no additional toppings.";
        }
        return description;
    };
}
...
// Create a hamburger
let myHamburger = new Hamburger("sesame seed", "beef", "cheddar", ["lettuce", "tomato", "pickles"]);
